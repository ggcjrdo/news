...
if(isset($_GET['search'])&&!empty($_GET['search'])){
    ...
    @$array = search($pageNum,$pageSize);

 ?>
</span>
<div class="container" role="main"><br>
<div class="row">
<div class="col-md-10">
...
<nav aria-label="Page navigation">
  <ul class="pagination">
    ...
    <li>
      <a href="?search=<?php echo $_SESSION['search']?>&&pageNum=<?php echo $pageNum==1?1:($pageNum-1)?>" aria-label="Previous">
        <span aria-hidden="true">上一页</span>
      </a>
    </li>
    <li>
      <a href="?search=<?php echo $_SESSION['search']?>&&pageNum=<?php echo $pageNum==$endPage?$endPage:($pageNum+1)?>" aria-label="Next">
